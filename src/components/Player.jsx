    ...
    return (
        <div className = "player h-[10%] bg-black flex justify-between items-center text-white px-4">
            <div className = "hidden lg:flex items-center gap-4">
                <img className = "w-12" src = { songsData[0].image } alt = "Song_Image" />
                <div>
            ...
            <div className = "flex flex-col items-center gap-1 m-auto">
                <div className = "flex gap-4">
                    ...
                    <img className = "w-4 cursor-pointer" src = { assets.prev_icon } alt = "prev_icon" />
                    <img className = "w-4 cursor-pointer" src = { assets.play_icon } alt = "play_icon" />
                    <img className = "w-4 cursor-pointer" src = { assets.next_icon } alt = "next_icon" />
